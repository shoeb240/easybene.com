<?php
/**
 * Application_Model_WageWorksHealthCareMapper class
 * 
 ...
 * @version    1.0
 */
class Application_Model_WageWorksHealthCareMapper
{
    /**
     * @var Application_Model_DbTable_WageWorksHealthCare
     */
     ...
     *
     * @return Application_Model_DbTable_WageWorksHealthCare
     */
    public function getTable()
    {
        if (null == $this->_dbTable) {
            $this->_dbTable = new Application_Model_DbTable_WageWorksHealthCare();
        }
     ...
     * @return string
     */
    public function getWageWorksHealthCare($userId)
    {
     ...
     * @return int
     */
    public function save(Application_Model_WageWorksHealthCare $medical)
    {
        $data = array(
    ...
    public function getWageWorksHealthCareUserAll()
    {
        $select = $this->getTable()->select();
        $select->from('wageworks_health_care', array('user_id'))
               ->group('user_id');
        $rowSets = $this->getTable()->fetchAll($select);
