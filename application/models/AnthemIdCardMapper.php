<?php
/**
 * Application_Model_AnthemIdCardMapper class
 * 
 ...
 * @version    1.0
 */
class Application_Model_AnthemIdCardMapper
{
    /**
     * @var Application_Model_DbTable_AnthemIdCard
     */
     ...
     *
     * @return Application_Model_DbTable_AnthemIdCard
     */
    public function getTable()
    {
        if (null == $this->_dbTable) {
            $this->_dbTable = new Application_Model_DbTable_AnthemIdCard();
        }
     ...
     * @return string
     */
    public function getAnthemIdCard($userId)
    {
     ...
     * @return int
     */
    public function save(Application_Model_AnthemIdCard $medical)
    {
        $data = array(
    ...
    public function getAnthemIdCardUserAll()
    {
        $select = $this->getTable()->select();
        $select->from('anthem_id_card', array('user_id'))
               ->group('user_id');
