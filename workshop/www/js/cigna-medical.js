            ...
            success: function(result) {
                    ...
                    if (result.claim_details[0]) {
                        $.each(result.claim_details, function (key, row){
                            ...
                            $('#cigna-claim').append('<tr role="row" class="'+odd_even+'"><td>'+row.claim_processed_on+'</td><td>'+row.for+'</td><td>'+row.service_amount_billed+'</td><td>'+row.service_what_i_owe+'</td><!--<td>'+row.status+'</td>--></tr>');
                        });
                    } else {
